...
(cl:defclass <Path> (roslisp-msg-protocol:ros-message)
  ((points
    :reader points
    :initarg :points
    :type (cl:vector ramp_msgs-msg:KnotPoint)
   :initform (cl:make-array 0 :element-type 'ramp_msgs-msg:KnotPoint :initial-element (cl:make-instance 'ramp_msgs-msg:KnotPoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Path>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Path)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ramp_msgs-msg:<Path> is deprecated: use ramp_msgs-msg:Path instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Path>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ramp_msgs-msg:KnotPoint))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Path>)))
  ...
  "dc3e2e8ac00d3e652ac961c6ad8ca08d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Path)))
  "Returns md5sum for a message object of type 'Path"
  "dc3e2e8ac00d3e652ac961c6ad8ca08d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Path>)))
  ...
  (cl:format cl:nil "ramp_msgs/KnotPoint[] points~%~%================================================================================~%MSG: ramp_msgs/KnotPoint~%ramp_msgs/MotionState motionState~%uint32 stopTime~%~%================================================================================~%MSG: ramp_msgs/MotionState~%float64[] positions~%float64[] velocities~%float64[] accelerations~%float64[] jerks~%~%# change to duration~%float64 time~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Path)))
  "Returns full string definition for message of type 'Path"
  (cl:format cl:nil "ramp_msgs/KnotPoint[] points~%~%================================================================================~%MSG: ramp_msgs/KnotPoint~%ramp_msgs/MotionState motionState~%uint32 stopTime~%~%================================================================================~%MSG: ramp_msgs/MotionState~%float64[] positions~%float64[] velocities~%float64[] accelerations~%float64[] jerks~%~%# change to duration~%float64 time~%~%~%"))
